...
<div class="main_wrapper">
	...
	<section id="content_start" style="width:600px;margin-bottom:50px;">
      <p> The nominal human hearing range is [20 Hz, 20 KHz]. However, and sadly, when getting older, we are gradulay losing the ability to hear high-frequency sounds. Try it to see what is the highest frequency that you can still hear now. </p>
